...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["image"])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            $sql = "INSERT INTO images (filename, filepath, description, upload_date) VALUES ('".basename($_FILES["image"]["name"])."', '$target_file', '$description', NOW())";

...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["image"])) {
    $target_dir = "images/installation/";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
            $sql = "INSERT INTO images3 (filename, filepath, description, upload_date) VALUES ('".basename($_FILES["image"]["name"])."', '$target_file', '$description', NOW())";
